...
function recipe_admin_init() {
	...
	add_filter( 'manage_recipe_posts_columns', 'add_new_recipe_columns' );
	add_action( 'manage_recipe_posts_custom_column', 'manage_recipe_columns', 10, 2); #10 priority 2 parameter
